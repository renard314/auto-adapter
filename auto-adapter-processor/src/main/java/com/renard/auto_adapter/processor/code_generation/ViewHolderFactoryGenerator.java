...
public class ViewHolderFactoryGenerator {
    ...
    public TypeSpec generate(final TypeElement model, final ClassName dataBindingClassName) {
        ...
        addCreateMethod(classBuilder, model, codeBlockForCreate(dataBindingClassName));
    ...
    public TypeSpec generate(final TypeElement model) {
        ...
        addCreateMethod(classBuilder, model, codeBlockForCreate());
        addGetViewTypeMethod(classBuilder);
    ...
    private void addCreateMethod(final TypeSpec.Builder viewHolderFactoryClass, final TypeElement model, CodeBlock codeBlock) {
        ...
        MethodSpec.Builder createMethod = MethodSpec
                .methodBuilder("create").returns(parameterizedTypeName)
